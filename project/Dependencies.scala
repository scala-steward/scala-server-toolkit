...
object Dependencies {
  ...
  val jetbrainsAnnotations = "org.jetbrains" % "annotations" % "26.1.0"
  ...
  val sentry = "io.sentry" % "sentry" % "8.38.0"
  ...
  object Versions {
    ...
    val grpc = "1.80.0"
    val http4s = "0.22.15"
    val micrometerCore = "1.16.5"
    val micrometerJmx = "1.16.5"
    val micrometerStatsD = "1.16.5"
    val micrometerPrometheus = "1.16.5"
    val monix = "3.4.1"
